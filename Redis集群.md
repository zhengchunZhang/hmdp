...
- 修改配置文件（永久生效）（这种方式必须要在每个redis的配置文件中添加主节点master的密码，masterauth 247108）

  ![image-20230501204946176](C:\Users\zhangzhengchun\AppData\Roaming\Typora\typora-user-images\image-20230501204946176.png)
